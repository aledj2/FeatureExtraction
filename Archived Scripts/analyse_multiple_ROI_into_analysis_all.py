...
class group_array_probes():
    def group_array_probes (self, analysistable,ROI_ID,array_ID):
        ...
        try:
            ...
            #print "retrieved Z scores for ROI_ID: " + str(ROI_ID)
        ...
        analyse_the_array().analyse(array_ID,listofgreenZscores,listofredZscores,analysistable,ROI_ID)
            
class analyse_the_array():
    def analyse (self, arrayID,greenZscores,redZscores,analysistable,ROI_ID):           
