...
class Calculate_Cutoffs():
    ...
    def lowest_abn_probe_count(self):
        ...
        sql = "select true_pos.Array_ID,true_pos.ROI_ID, true_pos.Gain_Loss,true_pos.Cy3_abn,true_pos.Cy5_abn,analysis_all.Num_of_probes,\
            analysis_all.Green_del_probes_95,analysis_all.Red_del_probes_95,analysis_all.Green_dup_probes_95,analysis_all.Red_dup_probes_95,\
    ...
    def highest_normal_probe_count(self):
        ...
        for i in self.list_of_abn_arrays:
            ...
            if cy3 == 1:
                ...
                sql = "select (Green_del_probes_95/Num_of_probes)*100,(Green_dup_probes_95/Num_of_probes)*100, Num_of_probes, analysis_all.array_ID, roi.roi_ID from analysis_all, ROI where analysis_all.ROI_ID=roi.roi_ID and  analysis_all.array_ID=%s and roi.ChromosomeNumber!= %s and roi.ChromosomeNumber <23"
                ...
                sql = "select (Red_del_probes_95/Num_of_probes)*100,(Red_dup_probes_95/Num_of_probes)*100, Num_of_probes, analysis_all.array_ID, roi.roi_ID from analysis_all, ROI where analysis_all.ROI_ID=roi.roi_ID and  analysis_all.array_ID=%s and roi.ChromosomeNumber!= %s and roi.ChromosomeNumber <23 and analysis_all.num_of_probes >10"
