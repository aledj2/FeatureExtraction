...
features = create_ins_statements()
...
features.looper(features.subset0,features.subset1)
features.looper(features.subset1,features.subset2)
features.looper(features.subset2,features.subset3)
features.looper(features.subset3,features.subset4)
features.looper(features.subset4,features.subset5)
features.looper(features.subset5,features.subset6)
features.looper(features.subset6,features.subset7)
features.looper(features.subset7,features.subset8)
features.looper(features.subset8,features.subset9)
features.looper(features.subset9,features.no_of_probes)
...
class insert_features:
    ...
    n=1  
    for i in features.insertstatementnames:
        ...
        try:
            cursor3.execute(features.insertstatements[i])
            db.commit()
