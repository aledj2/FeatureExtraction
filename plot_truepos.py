...
class Z_score_analysis:
    ...
    def read_db(self, list_of_arrays):
        ...
        sql1 = "select Array_ID, Chromosome ,first_probe,last_probe,Gain_Loss,CPA_Key from " + self.CPA + " where array_ID in " + query_array_list
        ...
        for i in list_of_arrays:
            ...
            sql3 = "select firstprobe, lastprobe \
            from true_pos \
            where Array_ID = %s "
            ...
            for j in abn_probes:
                ...
                try:
                    cursor.execute(sql4, (str(firstprobe), str(lastprobe), array_ID))
        ...
        for i in self.pos_dict_of_zscores_for_CPA_call:
            ...
            if i in self.correct_abbers:
                ...
                min = 100
                max = 0
                self.len_gain_truepos.append(len(self.pos_dict_of_zscores_for_CPA_call[i]))
                ...
                min = 100
                max = 0
                self.len_gain_falsepos.append(len(self.pos_dict_of_zscores_for_CPA_call[i]))
                for j in self.pos_dict_of_zscores_for_CPA_call[i]:
                    count = count + 1
                    sum = sum + j
                    if j < min:
        ...
        for i in self.neg_dict_of_zscores_for_CPA_call:
            ...
            if i in self.correct_abbers:
                ...
                count = 0
                sum = 0
                self.len_loss_truepos.append(len(self.neg_dict_of_zscores_for_CPA_call[i]))
                ...
                min = 100
                max = -100
                self.len_loss_falsepos.append(len(self.neg_dict_of_zscores_for_CPA_call[i]))
                for j in self.neg_dict_of_zscores_for_CPA_call[i]:
                    count = count + 1
                    sum = sum + j
                    if j < min:
        ...
        ax.hist(self.loss_average_truepos, bins=100, range=[-20, 0], histtype='stepfilled', color='r', label="Average loss true positive Z score")
        ax.set_title("average loss true positive Z score")

        ax2 = fig.add_subplot(222)
        ax2.hist(self.gain_average_truepos, bins=100, range=[0, 30], histtype='stepfilled', color='g', label="Average gain true positive Z score")
        ax2.set_title("average gain true positive Z score")
        ...
        ax5.hist(self.loss_max_truepos, bins=100, range=[-20, 0], histtype='stepfilled', color='r', label="max loss true positive Z score")
        ax5.set_title("true positive deletions")

        ax6 = fig2.add_subplot(222)
        ax6.hist(self.gain_min_truepos, bins=100, range=[0, 30], histtype='stepfilled', color='g', label="min gain true positive Z score")
        ax6.set_title("True positive duplications")
        ...
        fig2.suptitle("The lowest confidence Z scores for each call")

        ax9 = fig3.add_subplot(221)
        ax9.hist(self.loss_min_truepos, bins=100, range=[-20, 0], histtype='stepfilled', color='r', label="min loss true positive Z score")
        ax9.set_title("min loss true positive Z score")

        ax10 = fig3.add_subplot(222)
        ax10.hist(self.gain_max_truepos, bins=100, range=[0, 30], histtype='stepfilled', color='g', label="max gain true positive Z score")
        ax10.set_title("max gain true positive Z score")
        ...
        ax13.set_title("# probes in loss true positive Z score")
        ...
        ax14.set_title("# probes in gain true positive Z score")
        ...
        ax15.set_title("# probes in loss false positive Z score")
        ...
        ax16.set_title("# probes in gain false positive Z score")
