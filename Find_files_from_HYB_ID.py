...
list_of_arrays_file=open('S:\\Genetics_Data2\\Array\\Audits and Projects\\150512_Arrays_for_Aled\\book2.txt','r')
...
for i, line in enumerate(list_of_arrays_file):
    ...
    restofline=line.split('.')[1]
    subarray=restofline.split(' ')[0]
    dateofscan=restofline.split(' ')[1]
    ...
    filename_string.append('*'+str(barcode)+'_S01*'+arraycoord)
